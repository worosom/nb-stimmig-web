  ...
  <b-container>
    <b-row>
      <b-col>
        ...
        <h3>Hinweis zur verantwortlichen Stelle</h3> <p>Die verantwortliche Stelle f&uuml;r die Datenverarbeitung auf dieser Website ist:</p> <p>Nicola Berndt<br />
        Melanchthonstr. 29<br />
        10557 Berlin</p>

        <p>Telefon: 030 8876 3738<br />
          E-Mail: nb@stimmig-lautsprechersysteme.de</p>
...
export default {
  head: {
    title: 'Datenschutz - Stimmig Lautsprechersysteme'
  }
}
</script>
